function addInCartMessage(title, price) {
	...
	let  message = title;                             // присвойте переменной message значение переменной productName
	...
	message = message + " ";                        // <--Здесь еще один пробел забыли
...
function addInCartCountChange(value) {
	 ...
	 let newValue = value + 1;              // создайте переменную newValue
...
function addInCartSumChange(sum, delta) {
	...
	//let newSumText = newSum + " ₽"                      // создайте переменную newSumText и присвойте ей результат склеивания переменной newSum и текста ' ₽'
	 let newSumText = (`${oldSum + difference} ₽`);      // замените склеивание, используемое в newSum Text на шаблонную строку
